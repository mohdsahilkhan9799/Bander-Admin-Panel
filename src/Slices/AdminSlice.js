...
const savedUserDetails = (userData) => {
  ...
  export const RegisterUser = createAsyncThunk(
    "https://multi-vendor-project.vercel.app/api/vendor/VendorRegister",
...
export const LoginPost = createAsyncThunk(
  "https://multi-vendor-project.vercel.app/api/vendor/VendorLogin",
  async (formData, { dispatch, rejectWithValue }) => {
    try {
      dispatch(LoginStart());
      const response = await axios.post(
  ...
  async (_, { dispatch, rejectWithValue }) => {
    try {
      ...
      const response = await axios.get(
        `https://multi-vendor-project.vercel.app/api/vendor/getVendorRegisterUser`,
        {
          headers: {
